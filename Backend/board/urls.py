...
urlpatterns = [
    ...
    path('<str:session_id>/out/', BoardDisconnectView.as_view(), name="board_out"),
    ...
    path('<str:session_id>/tab/<int:tab_index>/history/<int:note_index>/detail/', HistoryDetailView.as_view(), name="tab_history_detail"),
