                  ...
                  <v-card-text>
                    <v-form class="signup-form-form">
                      ...
                      <div class="text-center mt-6">
                        <v-btn type="button" large :color="bgColor" dark @click="login(loginData)"
                          >Login</v-btn
                        >
                      </div>
                    </v-form>
                ...
                >
                  <div>
                    <v-card-text :class="`${fgColor}--text`">
                      ...
                      <h5 class="text-center overline mb-3">Please Login</h5>
                    </v-card-text>
                    <div class="text-center mb-6">
                      <v-btn dark outlined @click="step = 1">Login</v-btn>
                    </div>
                  </div>
                </v-col>
                <v-col cols="12" md="8" class=" pt-6 pb-6">
                  <v-card-text>
                    ...
                    <v-form class="signup-form-form" @submit.prevent="signup(signupData)">
                      <v-text-field
                        id="username"
